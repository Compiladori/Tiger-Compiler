...
class SemanticChecker {
    ...
    BindingTable<int> ProtectedEnv;

    std::stack<std::stack<ast::Symbol>> type_insertions, value_insertions, protected_insertions;
    ...
    auto getProtectedEntry(const ast::Symbol &s) { return ProtectedEnv.getEntry(s); }
    ...
    void insertProtectedEntry(ast::Symbol s, std::unique_ptr<int> type_entry, bool ignore_scope = false);
